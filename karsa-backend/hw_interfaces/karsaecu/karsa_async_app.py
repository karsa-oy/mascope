...
class KarsaClient(AsyncTCPClient):
    ...
    async def getNodeData(self, nId, obj, subIndex):
        payload = bytearray(4)
        payload[0] = nId
        payload[1] = (obj & 0xFF)
        payload[2] = (obj >> 8)
    ...
    async def stopMfcMeas(self, nId, obj, subIndex):
        payload = bytearray(4)
        payload[0] = nId
        payload[1] = (obj & 0xFF)
        payload[2] = (obj >> 8)
    ...
    async def startAiMeas(self, nId, chMask, interval):
        payload = bytearray(3)
        payload[0] = nId
        payload[1] = chMask
        payload[2] = interval
    ...
    async def stopAiMeas(self, nId, chMask):
        payload = bytearray(2)
        payload[0] = nId
        payload[1] = chMask
    ...
    async def startDioMeas(self, nId, interval):
        payload = bytearray(2)
        payload[0] = nId
        payload[1] = interval
