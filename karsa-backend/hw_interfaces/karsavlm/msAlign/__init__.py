...
def alignment_point_detection(peaks: list, window_size: float, for_vlm: bool, ref_spec: int):
    ...
    alignment_points, is_overlapping = remove_overlaps(tentative_alignment_point, window_size)
    vlm_list = [ vlm for i, vlm in enumerate(tentative_vlm_list) if not is_overlapping[i] ]
