...
from .kutil import(write_sampleid, 
                   read_sampleid,
                   write_description,
                   read_description
                   )
from .kspectra import KSpectra
from .kimage import (gen_heatmap_image,
...
class KEvent(KSpectra):
    ...
    def get_heatmap(self,
        ...
        t_range : tuple, optional
            2-tuple of floats, time range for heatmap.
            The default is None.
        mz_range : tuple, optional
            2-tuple of floats, m/z range or heatmap.
            The default is None.
        img_width : int, optional
            Heatmap width (px). The default is px/spectrum.
        img_height : int, optional
            Heatmap height (px). The default is 600.
        cache : bool, optional
            Load data into spectra_xarray property, to make
            consecutive method calls faster. The default is False.
    ...
    def get_spec_stack(self,
        ...
        ----------
        avg_s : float
            Averaging window for spectra in the image
        t_range : tuple, optional
            2-tuple of floats, time range for heatmap.
            The default is None.
        mz_range : tuple, optional
            ...
            The default is None.
        img_width : int, optional
            Heatmap width (px). The default is 600.
        img_height : int, optional
            Heatmap height (px). The default is 1200.
        cache : bool, optional
            Load data into spectra_xarray property, to make
            consecutive method calls faster. The default is False.
    ...
    def get_tps_traces(self, selected_traces=[], **kwargs):
        ...
        Parameters
        ----------
        selected_traces : list, optional
            List of int, the indices of desired parameters.
            The default is [].
        t0, t1, dt : float, optional
            use to specify time range. If not specified,
            full ranges are used.

        Returns
        -------
        traces : list
            List of dict with keys 'name', 'x', 'y', containing
    ...
    def get_spec_trace(self, t_range=None, mz_range=None):
        """[summary]
