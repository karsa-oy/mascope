"""
Migration script for v23 to v24 database migration.
"""
...
async def run():
    """
    Execute the v23 to v24 database migration
    """
    ...
    new_version = 24
    old_db_path = os.path.join(runtime.config.database, "mascope.v23.db")
