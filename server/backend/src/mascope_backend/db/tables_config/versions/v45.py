"""
Schema configuration for v45 database tables.

Changes from v44 to v45:
- Added missing FK indexes to fix slow ionization mechanism deletion (#1345):
  - ix_target_isotope_target_ion_id on target_isotope (target_ion_id)
  - ix_match_isotope_target_isotope_id on match_isotope (target_isotope_id)
  - ix_match_ion_target_ion_id on match_ion (target_ion_id)
...
table_configs = {
    "workspace": {
        "columns": {
            ...
            "workspace_type": ("VARCHAR(64)", 1, "ANALYSIS", 0),
            "locked": ("INTEGER", 1, "0", 0),
        ...
        "create_sql": """
            CREATE TABLE workspace (
                ...
                workspace_type VARCHAR(64) NOT NULL DEFAULT 'ANALYSIS',
    ...
    "ionization_mechanism": {
        "columns": {
            ...
            "ionization_mechanism": ("VARCHAR(256)", 1, None, 0),
        },
        "fks": {},
        "create_sql": """
            CREATE TABLE ionization_mechanism (
                ...
                ionization_mechanism VARCHAR(256) NOT NULL,
    ...
    "ionization_mode": {
        "columns": {
            "ionization_mode_id": ("VARCHAR(16)", 1, None, 1),
            "ionization_mode_name": ("VARCHAR(256)", 1, None, 0),
            "ionization_mode_token": ("VARCHAR(256)", 0, None, 0),
            "ionization_mode_polarity": ("VARCHAR(1)", 1, None, 0),
            "ionization_mechanism_ids": ("JSON", 1, None, 0),
        ...
        "create_sql": """
            CREATE TABLE ionization_mode (
                ...
                ionization_mode_name VARCHAR(256) NOT NULL,
    ...
    "match_sample": {
        "columns": {
            ...
            "sample_peak_intensity_sum": ("FLOAT", 1, None, 0),
        ...
        "create_sql": """
            CREATE TABLE match_sample (
                ...
                sample_peak_intensity_sum FLOAT NOT NULL,
    ...
    "match_isotope": {
        "columns": {
            ...
            "sample_item_id": ("VARCHAR(16)", 1, None, 0),
            "sample_peak_id": ("VARCHAR(20)", 1, None, 0),
    ...
    "sample_item": {
        "columns": {
            ...
            "sample_file_id": ("VARCHAR(16)", 1, None, 0),
            ...
            "ionization_mode_id": ("VARCHAR(16)", 0, None, 0),
            "t0": ("FLOAT", 0, None, 0),
            "t1": ("FLOAT", 0, None, 0),
        ...
        "create_sql": """
            CREATE TABLE sample_item (
                ...
                sample_file_id VARCHAR(16) NOT NULL
                    REFERENCES sample_file(sample_file_id) ON DELETE CASCADE,
        ...
        "indexes": [
            ...
            "idx_sample_item_sample_file ON sample_item (sample_file_id)",
        ],
    },
    "sample_batch": {
        "columns": {
            ...
            "sample_batch_name": ("VARCHAR(256)", 1, None, 0),
            "sample_batch_description": ("TEXT", 0, None, 0),
            "sample_batch_type": ("VARCHAR(64)", 1, "ANALYSIS", 0),
            "status": ("VARCHAR(20)", 1, "ready", 0),
            "locked": ("INTEGER", 1, "0", 0),
            "polarity": ("VARCHAR(4)", 1, "'+-'", 0),
        ...
        "create_sql": """
            CREATE TABLE sample_batch (
                ...
                sample_batch_name VARCHAR(256) NOT NULL,
                sample_batch_description TEXT,
                sample_batch_type VARCHAR(64) NOT NULL DEFAULT 'ANALYSIS',
                status VARCHAR(20) NOT NULL DEFAULT 'ready',
                locked INTEGER NOT NULL DEFAULT 0,
                polarity VARCHAR(4) NOT NULL DEFAULT '+-',
