...
def user_temp_dir(user_id: int) -> str:
    """
    Return the temp directory reserved for ``user_id``, creating it if needed.
...
def user_temp_path(user_id: int, filename: str) -> str:
    """
