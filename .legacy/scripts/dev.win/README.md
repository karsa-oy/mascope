...
deploy.cmd - re-start mascope from ../../.. project branch
deploy_loop.cmd - watch the ../../.. branch changes and re-start mascope if updated
...
### Staging version for Linux

#### Vagrant box:

1.  cd staging.linux.vbox
2.  deploy.cmd
