...
move %frontend_path%\mascope_ui.tar.gz mascope_bundle\ || (echo Error archiving mascope_ui & exit /b 1)
move %backend_path%\mascope_backend.tar.gz mascope_bundle\ || (echo Error archiving mascope_backend & exit /b 1)
