...
from mascope_server.api.controllers.match.match_aggregate import (
...
async def aggregate_matches(
    ...
    aggregated_match_isotope_filtered_data_df = await filter_match_isotope_data(
...
@api_controller()
async def reaggregate_and_create_matches(
    sample_batch_id: str = None,
    sample_item_id: str = None,
    target_ion_id: str = None,
    filter_params: FilterParams = None,
    ...
    """
    Re-aggregates and creates match data by first removing existing aggregates based on flags,
