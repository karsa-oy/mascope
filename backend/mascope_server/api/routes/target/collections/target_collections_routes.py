...
@target_collections_router.get("/api/target/collections")
@api_route()
...
@target_collections_router.get("/api/target/collections/{target_collection_id}")
@api_route()
async def get_target_collection_route(target_collection_id: str):
    return await get_target_collection(target_collection_id)


@target_collections_router.post("/api/target/collections")
@api_route(
    status_code=201,
)
...
@target_collections_router.patch("/api/target/collections/{target_collection_id}")
@api_route()
...
@target_collections_router.delete("/api/target/collections/{target_collection_id}")
@api_route()
