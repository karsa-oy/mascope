...
from mascope_server.api.controllers.match.targets.sample.match_targets_sample_controller import (
    get_match_sample_collections,
    get_match_sample_compounds,
    get_match_sample_ions,
    get_match_sample_isotopes,
)
from mascope_server.api.models.match.targets.sample.match_targets_sample_pydantic_model import (
...
@match_targets_sample_router.get(
    "/api/match/targets/sample/{sample_item_id}/collections",
    tags=["Sample Match Loading"],
)
@api_route()
...
@match_targets_sample_router.get(
    "/api/match/targets/sample/{sample_item_id}/ions", tags=["Sample Match Loading"]
)
@api_route()
...
@match_targets_sample_router.get(
    "/api/match/targets/sample/{sample_item_id}/isotopes", tags=["Sample Match Loading"]
)
@api_route()
