...
async def create_target_collection(
    ...
    async with async_session() as session:
        ...
        new_target_collection = TargetCollection(
            ...
            target_collection_type=target_collection.target_collection_type,
        )
    ...
    async with async_session() as session:
        ...
        if target_collection_update:
            ...
            if update_info:
                ...
                message_logs[
                    "update_info"
                ] = "No changes the in collection name, description or type."
        else:
            message_logs[
                "collection_update_info"
            ] = "No updates were provided for name and description."

        # Compounds adding logic
        if (
        ...
        # inform all the clients of the collection changes
