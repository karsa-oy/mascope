...
export function createHttpClient(host, api_port) {
  ...
  const httpClient = {
    ...
    deleteWorkspace: async (workspace) => {
      try {
        return await httpClient.delete(`${workspacesBaseUrl}/${workspace.workspace_id}`)
      } catch (error) {
    ...
    getBatchTargets: async ({ batchId, body }) => {
      try {
        return await httpClient.post(`${batchesBaseUrl}/${batchId}/targets`, body)
      } catch (error) {
    ...
    deleteBatch: async (batch) => {
      try {
        return await httpClient.delete(`${batchesBaseUrl}/${batch.sample_batch_id}`)
      } catch (error) {
    ...
    importSamplesToBatch: async ({ batch, body }) => {
      try {
        return await httpClient.post(`${batchesBaseUrl}/${batch.sample_batch_id}/import`, body)
      } catch (error) {
        // TODO_error_handling
        const userErrorMessage =
    ...
    batchExportPeakData: async (sampleBatchData) => {
      try {
        return await httpClient.post(`${batchesBaseUrl}/export_peaks`, sampleBatchData)
      } catch (error) {
    ...
    getSampleIonMatches: async ({ sampleId, body }) => {
      try {
        return await httpClient.post(`${samplesBaseUrl}/${sampleId}/ion_matches`, body)
      } catch (error) {
    ...
    getBatchMatchFilter: async (batchId) => {
      try {
        return await httpClient.get(`${samplesBaseUrl}/batch_match_filter/${batchId}`)
      } catch (error) {
    ...
    getSampleMatchFilter: async (sampleItemId, body) => {
      try {
        return await httpClient.post(`${samplesBaseUrl}/${sampleItemId}/sample_match_filter`, body)
      } catch (error) {
    ...
    updateSampleFile: async (sample_file_id, updatedSampleFile) => {
      try {
        return await httpClient.patch(`${filesBaseUrl}/${sample_file_id}`, updatedSampleFile)
      } catch (error) {
    ...
    updateSampleItem: async (sample_item_id, updatedSampleItem) => {
      try {
        return await httpClient.patch(`${itemsBaseUrl}/${sample_item_id}`, updatedSampleItem)
      } catch (error) {
    ...
    calibrationMzFit: async ({ sampleId, sampleName, body }) => {
      try {
        ...
        return await httpClient.post(`${calibrationBaseUrl}/mz_fit`, body, config)
      } catch (error) {
    ...
    calibrationMzApply: async ({ fit, sample_filename }) => {
      try {
        ...
        return await httpClient.post(`${calibrationBaseUrl}/mz_apply`, body, config)
      } catch (error) {
    ...
    calibrationMzCalibrateSample: async ({ sampleId, sampleName, body }) => {
      try {
        return await httpClient.post(`${calibrationBaseUrl}/mz_calibrate/sample/${sampleId}`, body)
      } catch (error) {
        const userErrorMessage =
          error?.response?.data?.error ||
    ...
    rematchBatch: async ({ batchId, body = {} }) => {
      try {
        return await httpClient.post(`${matchBaseUrl}/batch/${batchId}/rematch`, body)
      } catch (error) {
    ...
    matchSampleCompute: async ({ sampleId, body = {} }) => {
      try {
        return await httpClient.post(`${matchBaseUrl}/sample/${sampleId}/compute`, body)
      } catch (error) {
    ...
    matchSampleRematch: async ({ sampleId, body = {} }) => {
      try {
        return await httpClient.post(`${matchBaseUrl}/sample/${sampleId}/rematch`, body)
      } catch (error) {
    ...
    getTargetCollection: async (collectionId) => {
      try {
        return await httpClient.get(`${targetCollectionsBaseUrl}/${collectionId}`)
      } catch (error) {
    ...
    updateTargetCollection: async ({ collectionId, body }) => {
      try {
        return await httpClient.patch(`${targetCollectionsBaseUrl}/${collectionId}`, body)
      } catch (error) {
        const userErrorMessage =
          error?.response?.data?.error ||
    ...
    deleteTargetCollection: async ({ collectionId, collectionName, deleteOrphanCompounds }) => {
      try {
        return await httpClient.delete(`${targetCollectionsBaseUrl}/${collectionId}`, {
          params: {
    ...
    getTargetCompoundById: async (targetCompoundId) => {
      try {
        return await httpClient.get(`${targetCompoundsBaseUrl}/${targetCompoundId}`)
      } catch (error) {
    ...
    deleteTargetCompound: async (targetCompoundId) => {
      try {
        return await httpClient.delete(`${targetCompoundsBaseUrl}/${targetCompoundId}`)
      } catch (error) {
    ...
    getAllTargetCompoundsInTargetCollection: async (params = {}) => {
      try {
        return await httpClient.get(`${targetCompoundsInTargetCollectionBaseUrl}`, {
          params,
        })
      } catch (error) {
    ...
    updateTargetIon: async (data) => {
      try {
        return await httpClient.patch(`${targetIonsBaseUrl}/${data.target_ion_id}`, data.body)
      } catch (error) {
    ...
    getIonizationMechanismById: async (ionizationMechanismId) => {
      try {
        return await httpClient.get(`${ionizationMechanismsBaseUrl}/${ionizationMechanismId}`)
      } catch (error) {
    ...
    getMatchInterferenceById: async (interferenceId) => {
      try {
        return await httpClient.get(`${matchInterferencesBaseUrl}/${interferenceId}`)
      } catch (error) {
    ...
    getAttributeTemplate: async (templateId) => {
      try {
        return await httpClient.get(`${attributeTemplatesBaseUrl}/${templateId}`)
      } catch (error) {
        const userErrorMessage =
          error?.response?.data?.error ||
    ...
    updateAttributeTemplate: async ({ templateId, body }) => {
      try {
        return await httpClient.patch(`${attributeTemplatesBaseUrl}/${templateId}`, body)
      } catch (error) {
        const userErrorMessage =
          error?.response?.data?.error ||
    ...
    deleteAttributeTemplate: async ({ templateId, templateName }) => {
      try {
        return await httpClient.delete(`${attributeTemplatesBaseUrl}/${templateId}`)
      } catch (error) {
        const userErrorMessage =
          error?.response?.data?.error ||
