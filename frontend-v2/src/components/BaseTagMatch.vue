<script setup>
  ...
  const matchScore = computed(() => this.row !== null
  ...
  function clicked() {
    emit('tagClicked', this.row)
  }
</script>

<template>
  <b-field>
    <b-tooltip :active="tooltipActive" :delay="200" position="is-left" type="is-white" append-to-body size="is-small"
      multilined>
      <b-tag v-if="!(matchScore === null || isNaN(matchScore))" :icon="tag.icon" :class="tag.class"
        style="font-size: small" @click="clicked">
