...
$Main = {
    ...
    Installing everything the Mascope dev env and tooling...
...
"@
    ...
    +--------------------------------------+
    | ✨ MASCOPE WINDOWS DEV ENV UPDATE ✨ |
    +--------------------------------------+

    Updating the Mascope CLI and dev env...
...
"@
    ...
    Set-EnvVar 'MASCOPE_PATH' (Get-Item $PSScriptRoot).parent.parent.FullName
}
...
"@
    ...
    # see /scripts/cli
    Set-Location "${env:MASCOPE_PATH}\tooling\cli"
    # poetry build
